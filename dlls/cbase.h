...
public:
    ...
    virtual void area_SetIndex( int index ) {}
    virtual void area_SendStatus( CBasePlayer *p ) {}
    ...
    virtual TOGGLE_STATE GetState( void ) { return TS_AT_TOP; }
    virtual TOGGLE_STATE GetState( CBaseEntity *pEnt ) { pEnt->GetState(); }
