...
ItemInfo CBasePlayerItem::ItemInfoArray[MAX_WEAPONS_DOD];
...
void CBasePlayer::DropPlayerItem( char *pszItemName, bool bForceDrop ) { }
BOOL CBasePlayer::HasPlayerItem( CBasePlayerItem *pCheckItem ) { return FALSE; }
BOOL CBasePlayer::SwitchWeapon( CBasePlayerItem *pWeapon, BOOL bJustSpawned )  { return FALSE; }
